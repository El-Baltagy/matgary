...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  CollectionReference anonymous = firestore.collection('anonymous');
  @override
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      GoPage.push(context, path: const CustomerOrders());
                                    },
                                  ),
                                ),
                                Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      GoPage.push(context, path: WishlistScreen());
                                    },
                                  ),
                                )
                              ],
