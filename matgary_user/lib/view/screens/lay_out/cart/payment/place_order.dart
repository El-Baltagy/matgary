...
import 'package:matgary_user/view/screens/lay_out/cart/payment/payment_screen.dart';
...
class _PlaceOrderScreenState extends State<PlaceOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(
        future: customers.doc(fAuth.currentUser!.uid).get(),
        builder:
                  ...
                  bottomSheet: Container(
                    ...
                    child: Padding(
                      ...
                      child: YellowButton(
                        ...
                        width: 1,
                        onPressed: () {
                          GoPage.push(context, path: const PaymentScreen());
                        },
                      ),
                    ),
                  ),
