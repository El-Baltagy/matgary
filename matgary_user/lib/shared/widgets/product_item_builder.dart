...
import 'mior_sc/product_detail_sc.dart';
                        ...
                        Row(
                         ...
                         CashHelper.saveData(key: '${widget.products['proid']} isSaved', value: true);
                            prov.InsertTODatabase(context,
                              ...
                              proname: widget.products['proname'],
                              proimages: widget.products['proimages'][0],
                              price: widget.products['price'].toString(),
                              totalPrice: ((1 - (widget.products['discount'] / 100)) *
                                  widget.products['price'])
                                .toStringAsFixed(2), discount: widget.products['discount'],

                                           );
                                          } else{
                                            CashHelper.saveData(key: '${widget.products['proid']} isSaved', value: false);
                                            prov.DeleteDatebase(context,id:(widget.products['proid']).toString());
                                            // if (widget.isFavSC) {
