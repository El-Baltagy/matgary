...
import 'package:matgary_admin/controller/cubit/product_detail/ProDetailState.dart';
import 'package:matgary_admin/shared/utils/app_methods.dart';
import 'package:matgary_admin/shared/widgets/loader.dart';
import 'package:matgary_admin/shared/widgets/product_item_builder.dart';
import 'package:matgary_admin/shared/widgets/yellow_button.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_grid_view.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_tile.dart';
import 'package:badges/badges.dart'as badges ;
import '../../controller/cubit/product_detail/product_detail.dart';
import '../../view/screens/lay_out/dashboard/minor_sc/visit_store.dart';
                                ...
                                IconButton(
                                    onPressed: () {
                                      if (!isFav) {
                                        ...
                                        context.read<ProDetailBloc>().InsertTODatabase(context,
                                          idProduct: widget.proList['proid'],
                                        );
                                      } else{
                                        CashHelper.saveData(key: '${widget.proList['proid']} isSaved', value: false);
                                        context.read<ProDetailBloc>().DeleteDatebase(context,id:(widget.proList['proid']).toString());
                                        // if (widget.isFavSC) {
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                          ...
                          icon: BlocBuilder<ProDetailBloc, ProDetailState>(
                           ...
                           YellowButton(
                         label:
                         // Provider.of<ProductDetailProv>(context).saveData.isEmpty
                         //  ? 'added to cart':
                               'ADD TO CART',
                      onPressed: () {
